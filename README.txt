...
The program facilitates encoding of binary data of maximum size 28,501,824 bits into short-length synthetic DNA molecules of length upto 239 nt.
...
(User needs to create a binary text file in the parent folder DNA-DATA-ENCODER-main and store the desired data in the aforementioned format in the text file. The data size is b bits, where b is the Column no. of the last bit in Line 1 of text file).
